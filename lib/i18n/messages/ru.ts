...
export const ru: Messages = {
  ...
  socialView: {
    ...
    instagramImageUrl: 'Изображение для Instagram',
  ...
  adsView: {
    title: 'Реклама',
    description: 'Рекламные кампании по проекту — расход, лиды и выручка в одном месте.',
    addCampaign: '+ Добавить кампанию',
    searchPlaceholder: 'Поиск по названию',
    filterPlatform: 'Платформа',
    filterStatus: 'Статус',
    noResults: 'Нет кампаний, соответствующих текущим фильтрам.',
    detailLabel: 'Кампания',
    name: 'Название',
    platform: 'Платформа',
    status: 'Статус',
    budget: 'Бюджет',
    ...
    confirmDelete: 'Удалить кампанию «{name}»? Это действие необратимо.',
