export const en = {
  ...
  socialView: {
    title: 'Social',
    description: 'Planned and published posts for this project, with per-channel copy in one place.',
    addPost: '+ Add post',
    ...
    instagramImageUrl: 'Instagram image',
    uploadImage: 'Upload image',
    uploadingImage: 'Uploading…',
    replaceImage: 'Replace image',
    uploadImageError: 'Could not upload image. Please try again.',
  ...
  socialAccountsView: {
    title: 'Accounts',
    description: 'Social accounts for this project, ready to be linked to posts once you connect them.',
    ...
    notes: 'Notes',
    active: 'Active',
    noResults: 'No accounts match the current filters.',
    detailLabel: 'Account',
  ...
  adsView: {
    title: 'Ads',
    description: 'Ad campaigns for this project, with spend, leads and revenue tracked in one place.',
    addCampaign: '+ Add campaign',
    searchPlaceholder: 'Search name',
    filterPlatform: 'Platform',
    filterStatus: 'Status',
    noResults: 'No campaigns match the current filters.',
